...
| 3 | Ship `/blog/airtable-alternatives` with an AI-agent dataset angle | Blog alternatives | in_progress | branch `scribe/airtable-alternatives-blog-rewrite` |
| 4 | Ship `/blog/google-sheets-alternatives` with an MCP/REST backend angle | Blog alternatives | pending | - |
