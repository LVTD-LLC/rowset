...
| Scoped low-noise typing for helpers, row contracts, schemas, service code, dataset model/task code, and app support modules | `make type-check` | Expand the typed scope only in focused type-checking work; see [typing.md](typing.md) |
