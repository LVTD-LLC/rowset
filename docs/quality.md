...
| Scoped low-noise typing for helpers, row contracts, schemas, and pure boundaries | `make type-check` | Expand the typed scope only in focused type-checking work; see [typing.md](typing.md) |
