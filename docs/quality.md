...
3. `make format-check`
4. `make type-check`
5. `make frontend-install`
6. `make frontend-check`
7. Reset the local `test_rowset` database
8. `make migrations-check`
9. `make django-check`
10. `make test -- apps/core apps/docs apps/pages apps/blog -q`
11. `make test -- apps/datasets -q`
12. `make test -- apps/api -q`
13. `make test -- apps/mcp_server -q`
...
| Scoped low-noise typing | `make type-check` | Expand the typed scope only in focused type-checking work; see [typing.md](typing.md) |
