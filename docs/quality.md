...
| Scoped low-noise typing | `make type-check` | Expand the typed scope only in focused type-checking work; current scope includes pure helpers plus `apps/api/row_contracts.py`; see [typing.md](typing.md) |
