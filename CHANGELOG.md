...
### Added
- Dashboard home now includes a copyable “teach your AI agent to use FileBridge” prompt with the user's MCP URL, REST API base, API key, and a linked public agent skill file.
