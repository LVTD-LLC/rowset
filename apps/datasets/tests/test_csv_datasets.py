...
def test_project_section_api_creates_section_and_assigns_dataset(client, profile):
    ...
    sections_response = client.get(f"/api/projects/{project.key}/sections?api_key={profile.key}")
...
def test_project_detail_api_reports_dataset_total_count_on_paginated_page(client, profile):
    project = Project.objects.create(profile=profile, name="Rowset")
...
def test_project_detail_api_omits_section_groups_from_dataset_page(client, profile):
    assert hasattr(dataset_models, "ProjectSection")
    ProjectSection = dataset_models.ProjectSection
    project = Project.objects.create(profile=profile, name="Rowset")
