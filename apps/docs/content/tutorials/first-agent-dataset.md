...
- [Configure agent access](/docs/how-to-guides/configure-agent-access/) for
  permissions, installable skills, and setup prompts.
- [Connect over MCP](/docs/how-to-guides/connect-mcp/) for a focused MCP setup
  guide.
- [Dataset API](/docs/reference/dataset-api/) for REST endpoint details.
- [How Rowset datasets work](/docs/explanation/datasets/) for index columns,
