...
These guidelines ensure documentation is user-friendly, clear, and actionable for Rowset users.

## Product Direction

- Rowset is an AI-native, agent-first tool for managing and sharing datasets.
