...
ROWSET_AGENT_SETUP_INSTRUCTIONS = (
    ...
    "the env var contains the full key, not only its prefix. Use get_dataset "
    "before row work so dataset context, schema, and relationships are in "
    "context. Use create_dataset when you need to create a dataset on the fly. "
