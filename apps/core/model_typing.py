...
class ProfileQuerySet(Protocol):
    ...
    def all(self) -> ProfileQuerySet: ...

    def annotate(self, **annotations: object) -> ProfileQuerySet: ...

    def count(self) -> int: ...

    def exclude(self, **filters: object) -> ProfileQuerySet: ...
    ...
    def select_related(self, *fields: str) -> ProfileQuerySet: ...


class ProfileManager(ProfileQuerySet, Protocol):
...
class AgentApiKeyQuerySet(Protocol):
    def __iter__(self) -> Iterator[AgentApiKey]: ...

    def all(self) -> AgentApiKeyQuerySet: ...

    def annotate(self, **annotations: object) -> AgentApiKeyQuerySet: ...

    def count(self) -> int: ...

    def exclude(self, **filters: object) -> AgentApiKeyQuerySet: ...

    def exists(self) -> bool: ...

    def filter(self, **filters: object) -> AgentApiKeyQuerySet: ...

    def first(self) -> AgentApiKey | None: ...

    def get(self, **filters: object) -> AgentApiKey: ...

    def select_related(self, *fields: str) -> AgentApiKeyQuerySet: ...


class AgentApiKeyManager(AgentApiKeyQuerySet, Protocol):
    def create(self, **fields: object) -> AgentApiKey: ...
