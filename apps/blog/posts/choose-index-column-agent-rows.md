...
access](/docs/how-to-guides/connect-mcp/) and the [Dataset API](/docs/reference/dataset-api/).
...
This is also where [agent discovery](/docs/how-to-guides/help-agents-discover-rowset/) matters.
