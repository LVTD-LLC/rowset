...
access](/docs/how-to-guides/connect-mcp/) or the [Dataset API](/docs/reference/dataset-api/).
...
guide](/docs/tutorials/first-agent-dataset/), connect an agent through
[MCP](/docs/how-to-guides/connect-mcp/), and ask it to create one small dataset for a real
workflow.
