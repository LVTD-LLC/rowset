"""
Django settings for filebridge project.
...
WSGI_APPLICATION = "filebridge.wsgi.application"
...
ACCOUNT_ADAPTER = "filebridge.adapters.CustomAccountAdapter"
if ENVIRONMENT != "dev":
...
if ENVIRONMENT == "prod":
    ...
    LOGGING["loggers"]["filebridge"]["level"] = env("DJANGO_LOG_LEVEL", default="INFO")
    LOGGING["loggers"]["filebridge"]["handlers"].append("json_console")
